...
param environmentName string='azure-search-openai-demo'
...
param computerVisionResourceGroupLocation string = 'japaneast' // Vision vectorize API is yet to be deployed globally
param computerVisionSkuName string = 'F0'
...
param gpt4vModelName string = 'gpt-3.5-turbo'
param gpt4vDeploymentName string = 'gpt-3.5-turbo'
